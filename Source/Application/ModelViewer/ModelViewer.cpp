...
#include "GameEngine/Input/EnumKeys.h"
...
{
	//ImVec4 mainColor = { 0.1f, 0.1f, 0.1f, 0.8f };
	//ImVec4 accentColor = { 0.5f, 0.3f, 0, 1.0f };
	//ImVec4 accentColorActive = { 0.6f, 0.4f, 0, 1.0f };
	//ImVec4 accentColorInactive = { 0.3f, 0.1f, 0, 0.5f };
	//ImVec4 accentColorInteracted = { 0.8f, 0.5f, 0, 1.0f };

	//ImVec4 textColor = { 1.0f, 1.0f, 1.0f, 1.0f };
	//ImVec4 textColorDisabled = { 0.6f, 0.6f, 0.6f, 1.0f };
	...
	//style.Colors[ImGuiCol_TitleBgCollapsed] = accentColorInactive;
	//style.Colors[ImGuiCol_FrameBg] = accentColor;
	//style.Colors[ImGuiCol_FrameBgHovered] = accentColorInteracted;
	//style.Colors[ImGuiCol_FrameBgActive] = accentColorActive;
	//style.Colors[ImGuiCol_MenuBarBg] = accentColor;
	//style.Colors[ImGuiCol_ScrollbarBg] = accentColor;
	//style.Colors[ImGuiCol_ScrollbarGrab] = accentColor;
	//style.Colors[ImGuiCol_ScrollbarGrabHovered] = accentColorInteracted;
	//style.Colors[ImGuiCol_ScrollbarGrabActive] = accentColorActive;
	//style.Colors[ImGuiCol_CheckMark] = textColor;
	//style.Colors[ImGuiCol_SliderGrab] = textColorDisabled;
	//style.Colors[ImGuiCol_SliderGrabActive] = textColor;
	//style.Colors[ImGuiCol_Button] = accentColorInteracted;
	//style.Colors[ImGuiCol_ButtonHovered] = accentColorInteracted;
	//style.Colors[ImGuiCol_ButtonActive] = textColor;
	//style.Colors[ImGuiCol_Header] = accentColor;
	//style.Colors[ImGuiCol_HeaderHovered] = accentColorInteracted;
...
void ModelViewer::UpdateImgui()
{
	...
	// Performance Info
	{
		...
		// Memory Usage
		{
			timeSinceLastMemoryCheck += Engine::GetInstance().GetTimer().GetDeltaTime();
			if (timeSinceLastMemoryCheck > memoryCheckTimeInterval)
			{
				timeSinceLastMemoryCheck = 0;
				...
				if (hProcess != NULL)
				{
					if (GetProcessMemoryInfo(hProcess, &pmc, sizeof(pmc)))
					{
						...
						ramUsageChange = newRamUsage - ramUsage;
