...
#include "../Controllers/Seek.h"
#include "../Controllers/CollisionAvoidance.h"
...
void ControllerMoveWeighted::AddControllerType(ControllerType aControllerType, float aBlendWeight)
{
	...
	{
	case ControllerMoveWeighted::ControllerType::Seek:
		mySteeringBehaviours[aControllerType] = new Seek();
		break;
